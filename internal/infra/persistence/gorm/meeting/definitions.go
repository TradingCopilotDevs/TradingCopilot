...
var ToolDefinitions = []CapabilityDefinition{
	...
	{Key: "prediction.search_markets", Title: "Prediction Market Search", Description: "Search Polymarket events and binary markets for related public prediction contracts, returning local event and market IDs plus event slug/title for follow-up tools.", Category: "Prediction Market"},
	{Key: "prediction.market_snapshot", Title: "Prediction Market Snapshot", Description: "Read current stored event ID, event slug/title, price, liquidity, status, outcomes, token IDs, and outcome-token mapping for linked prediction markets.", Category: "Prediction Market"},
	{Key: "prediction.orderbook", Title: "Prediction Order Book", Description: "Fetch Polymarket CLOB order book data for a linked market outcome token, including local event ID, event slug/title, selected outcome label, and token mapping.", Category: "Prediction Market"},
	{Key: "prediction.price_history", Title: "Prediction Price History", Description: "Fetch recent Polymarket price history for a linked market outcome token, including local event ID, event slug/title, selected outcome label, and token mapping.", Category: "Prediction Market"},
	...
	{Key: "prediction.watchlist", Title: "Prediction Watchlist", Description: "Read existing prediction watchlist items for the current prediction research team, including local market ID, event slug/title, active flag, notes, and market snapshot fields.", Category: "Prediction Market"},
	{Key: "prediction.upsert_watchlist", Title: "Prediction Watchlist Action", Description: "Propose adding or updating a Polymarket market in the prediction watchlist by local market ID; executed only during the moderator recap.", Category: "Prediction Market"},
